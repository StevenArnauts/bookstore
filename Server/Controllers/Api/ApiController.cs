...
namespace Bookstore.Controllers {
	...
	public class ApiController : ControllerBase {
		...
		private readonly CustomerRepository _senders;
		private readonly OrderRepository _receivers;

		public ApiController(CustomerRepository senders, OrderRepository receivers) {
